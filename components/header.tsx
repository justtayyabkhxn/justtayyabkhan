  ...
  return (
    <div className="flex sm:flex-row flex-col-reverse items-center justify-between w-full pt-4 gap-6">
      <div className="flex flex-col space-y-3 min-w-0 items-center sm:items-start text-center sm:text-left">
        ...
        <p className="text-sm text-muted-foreground"><span className="text-orange-400 font-semibold">Full-Stack Developer</span> · Freelancer</p>
      ...
      <Image
        ...
        height={120}
        alt="Tayyab Khan"
        className="size-20 sm:size-[120px] rounded-full opacity-90 shrink-0"
      />
    </div>
  );
};
